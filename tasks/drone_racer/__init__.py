...
gym.register(
    id="Isaac-Drone-Racer-Swift-CTBR-GT-Circular12-ExpertDemo-v0",
    entry_point=f"{__name__}.swift_ctbr_racing_env:SwiftCTBRRacingEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.drone_racer_swift_ctbr_env_cfg:"
            "DroneRacerSwiftCTBRGTCircular12ExpertDemoEnvCfg"
        ),
        "skrl_cfg_entry_point": (
            f"{agents.__name__}:skrl_swift_ctbr_gt_circular12_imitation_cfg.yaml"
        ),
...
gym.register(
    id="Isaac-Drone-Racer-Swift-CTBR-GT-Circular12-ExpertValidation-v0",
    entry_point=f"{__name__}.swift_ctbr_racing_env:SwiftCTBRRacingEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="Isaac-Drone-Racer-Swift-CTBR-GT-Circular12-ImitationResidualNoise-v0",
    entry_point=f"{__name__}.swift_ctbr_racing_env:SwiftCTBRRacingEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.drone_racer_swift_ctbr_env_cfg:"
            "DroneRacerSwiftCTBRGTCircular12ImitationResidualNoiseEnvCfg"
        ),
        "skrl_cfg_entry_point": (
            f"{agents.__name__}:skrl_swift_ctbr_gt_circular12_imitation_cfg.yaml"
        ),
...
_register_circular12_imitation_estimator_task(
    "Isaac-Drone-Racer-Learned-Inertial-Swift-CTBR-Circular12-Imitation-GTShadow-Coordinated14-Color20-OracleAssociation-v0",
    "DroneRacerLearnedInertialSwiftCTBRCircular12ImitationGTShadowCoordinated14Color20OracleAssociationCfg",
)
_register_circular12_imitation_estimator_task(
...
_register_circular12_imitation_estimator_task(
    ...
    "DroneRacerLearnedInertialSwiftCTBRCircular12ImitationEstStateTruthMissionCoordinated14Color20Cfg",
)
_register_circular12_imitation_estimator_task(
